...
- If you are running v0.8.7.4 as distributed by technocoin.org you do not need to upgrade.
  The binaries distributed on technocoin.org contain their own copy of openssl so they are unaffected by this issue.
